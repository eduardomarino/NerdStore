...
public class PagamentoService : IPagamentoService
{
    ...
    public async Task<Transacao> RealizarPagamentoPedido(PagamentoPedidoDTO pagamentoPedido)
    {
        ...
        {
            pagamento.AdicionarEvento(new PagamentoRealizadoIntegrationEvent(pedido.Id, pagamentoPedido.ClienteId, transacao.PagamentoId, transacao.Id, pedido.Valor));
        ...
        await _mediatorHandler.PublicarEvento(new PagamentoRecusadoIntegrationEvent(pedido.Id, pagamentoPedido.ClienteId, transacao.PagamentoId, transacao.Id, pedido.Valor));
